...
//  SalaryManagement
//
//  Created by deepin do on 2020/10/10.
//
...
class DoPermission: NSObject {
    
    static let shared = DoPermission()
 ...
 */
    ...
    // 检测权限, 并跳转界面
    func judgePermission(_ type: PermissionType, _ controller: UIViewController,_ completion: (() -> ())) {
        switch type {
        case .photo:
            if !isPhotoed() {
...
//            break
    ...
    // 没有权限的 弹框
    func showAlert(_ title: String, _ messsage: String, _ controller: UIViewController) {
...
//extension DDAuthorization: UIAlertViewDelegate {
//
//    func alertView(_ alertView: UIAlertView, clickedButtonAt buttonIndex: Int) {
//
//        if buttonIndex == 0 {
//        } else if buttonIndex == 1 {
//            toSystemPrivacySetting()
//        }
//    }
//}
