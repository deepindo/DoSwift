...
/**
 ...
 获取代码所在的行数 #line函数
 */
public func DoLog<T>(_ content: T, file: String = #file, functionName: String = #function, line: Int = #line) {
...
public func DoLocalizable(_ key: String) -> String {
...
public func isiPhoneSerial() -> Bool {
    if #available(iOS 11.0, *) {
        return ((UIApplication.shared.keyWindow?.safeAreaInsets.bottom)! > 0) ? true : false
    } else {
        return false
    }
}
...
public func DoNotice(_ content: String) {
    //LPPopup.popupCustomText(content)
    DoLog("will add in future")
}
...
public func DoImage(_ name: String) -> UIImage {
