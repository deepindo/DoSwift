...
/// 判断iPhone12Mini
public let IS_IPHONE_12Mini  = (UIScreen.instancesRespond(to: #selector(getter: UIScreen.currentMode)) ? (__CGSizeEqualToSize(CGSize(width: 1080, height: 2340), (UIScreen.main.currentMode?.size)!)) && !IS_IPAD : false)

/// 判断iPhone12
public let IS_IPHONE_12  = (UIScreen.instancesRespond(to: #selector(getter: UIScreen.currentMode)) ? (__CGSizeEqualToSize(CGSize(width: 1170, height: 2532), (UIScreen.main.currentMode?.size)!)) && !IS_IPAD : false)

/// 判断iPhone12Pro
public let IS_IPHONE_12Pro  = (UIScreen.instancesRespond(to: #selector(getter: UIScreen.currentMode)) ? (__CGSizeEqualToSize(CGSize(width: 1170, height: 2532), (UIScreen.main.currentMode?.size)!)) && !IS_IPAD : false)

/// 判断iPhone12Pro_Max
public let IS_IPHONE_12Pro_Max  = (UIScreen.instancesRespond(to: #selector(getter: UIScreen.currentMode)) ? (__CGSizeEqualToSize(CGSize(width: 1284, height: 2778), (UIScreen.main.currentMode?.size)!)) && !IS_IPAD : false)

/// 判断 所有iPhoneX系列
public let IS_IPhoneX_Serial = (IS_IPHONE_X == true
                                    || IS_IPHONE_XR == true
                                    || IS_IPHONE_XS == true
                                    || IS_IPHONE_XS_Max == true
                                    || IS_IPHONE_11 == true
                                    || IS_IPHONE_11Pro == true
                                    || IS_IPHONE_11Pro_Max == true
                                    || IS_IPHONE_12Mini == true
                                    || IS_IPHONE_12 == true
                                    || IS_IPHONE_12Pro == true
                                    || IS_IPHONE_12Pro_Max == true) ? true : false
